...
- `src/agent_learning/llm/human_in_loop.py`: Chapter 13 interrupt approval gate service
...
- `guides/chapters/`: chapter별 상세 학습 문서
...
- chapter-facing 설명은 README, `guides/chapters.md` 인덱스, `guides/chapters/<chapter>.md`, `docs/learning-roadmap.md`, `docs/progress.md`를 함께 맞춥니다.
